...
const solutions = [
  ...
  },
  {
    ...
    description: 'No API keys to manage, no documentation to read. Just discover and connect.',
  ...
  },
  {
    ...
    description: 'Works with any protocol - MCP, A2A, OpenAPI, local packages, or custom APIs.',
    iconColor: 'text-primary',
    iconBg: 'bg-muted',
  },
];
