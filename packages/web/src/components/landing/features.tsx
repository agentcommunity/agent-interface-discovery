              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-amber-500/10 shadow-soft-xs transition-all duration-300 group-hover:scale-110 group-hover:shadow-soft-md">
                      <problem.icon className="h-6 w-6 text-amber-500 transition-transform duration-300 group-hover:scale-110" />
                    </div>
